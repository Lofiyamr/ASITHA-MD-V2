...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=arQCEQbB#vomexdsJxMbNZlObei_8c0TIDVuTwNhWVLxUcyjGots' : process.env.SESSION_ID,
...
AUTO_STICKER: process.env.AUTO_STICKER === undefined ? "fales" : process.env.AUTO_STICKER,
...
AI_CHAT: process.env.AI_CHAT === undefined ? "fales" : process.env.AI_CHAT,
